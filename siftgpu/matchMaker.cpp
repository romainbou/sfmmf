...
int main()
{
    ...
    for (it=imageList.begin(); it!=imageList.end(); ++it) {
        iImg++;
        for (it2=imageList.begin(); it2!=imageList.end(); ++it2) {
          jImg++;
          if(it != it2){

            string image1Path = *it;
            string image2Path = *it2;


            if(sift->RunSIFT(image1Path.c_str()))
            {
                //get feature count
            ...
            if(sift->RunSIFT(image2Path.c_str()))
            {
                //get feature count
                num2 = sift->GetFeatureNum();

                //allocate memory
                keys2.resize(num1);    descriptors2.resize(128*num1);
            ...
            cout << "Between img: " << iImg << " | " << jImg << endl;
            cout << "nb matches: " << num_match << endl;
            for(int i  = 0; i < num_match; ++i)
            {
              ...
              cout << "key1: " << match_buf[i][0] << endl;
              cout << "key2: " << match_buf[i][1] << endl;
